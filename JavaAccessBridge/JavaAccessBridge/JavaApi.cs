...
namespace JavaAccessBridge {
    ...
    public static class JabApi
    {
        ...
        [DllImport(WinAccessBridgeDll, SetLastError = true, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
        public extern static unsafe Int32 getAccessibleSelectionCountFromContext(Int32 vmID, IntPtr AccessibleContext);

        [DllImport(WinAccessBridgeDll, SetLastError = true, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)]
        public extern static unsafe Boolean isAccessibleChildSelectedFromContext(Int32 vmID, IntPtr AccessibleContext,Int32 index);
    }
}
